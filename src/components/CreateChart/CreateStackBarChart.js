                            ...
                            <div id="element" ref={element} >
                                ...
                                <ResponsiveContainer width={'100%'} height={350} >
                                    ...
                                    >
                                        ...
                                        <Bar dataKey={setup.data1} stackId="a" fill={setup.color1} stroke="#8884d8">
                                            <LabelList dataKey={setup.data1} position="inside" style={{ zIndex: '1' }} />
                                        </Bar>

                                        <Bar dataKey={setup.data2} stackId="a" fill={setup.color2} stroke="#8884d8">
                                            <LabelList dataKey={setup.data2} position="inside" style={{ zIndex: '1' }} />
                                        </Bar>

                                        <Bar dataKey={setup.data3} stackId="a" fill={setup.color3} stroke="#8884d8">
...
export default CreateStackBarChart;