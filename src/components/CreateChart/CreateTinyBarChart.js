...
const CreateTinyBarChart = () => {
    ...
    return (
        <div>
            <Container>
                <br />
                <h2 className="text-muted border-bottom text-center pb-2">Make Your Customized Tiny Bar Chart</h2>
                <br />
...
export default CreateTinyBarChart;