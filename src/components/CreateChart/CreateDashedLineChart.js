...
const CreateDashedLineChart = () => {
    ...
    return (
        <div>
            <Container>
                <br />
                <h2 className="text-muted border-bottom text-center pb-2">Make Your Customized Dashed Line Chart</h2>
                <br />
                            ...
                            <div id="element" ref={element} >
                                <ResponsiveContainer width={'100%'} height={350} >
                                    <LineChart data={newInput}
                                        ...
                                        <Tooltip />
                                        <Legend />
                                        <Line type="monotone" dataKey={setup.data1} stroke={`${setup.color1}`} strokeDasharray="5 5" >
                                            <LabelList dataKey={setup.data1} position="top" />
                                        </Line>
                                        <Line type="monotone" dataKey={setup.data2} stroke={`${setup.color2}`} strokeDasharray="5 4 5 2" >
                                            <LabelList dataKey={setup.data1} position="top" />
                                        </Line>
                                    </LineChart>
                                </ResponsiveContainer>
...
export default CreateDashedLineChart;