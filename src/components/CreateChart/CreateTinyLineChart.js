...
const CreateTinyLineChart = () => {
    ...
    return (
        <div>
            <Container>
                <br />
                <h2 className="text-muted border-bottom text-center pb-2">Make Your Customized Tiny Line Chart</h2>
                <br />
                            ...
                            <div id="element" ref={element} >
                                <ResponsiveContainer width={'100%'} height={350} >
                                    ...
                                    >
                                        ...
                                        <Tooltip />
                                        <Legend />
                                        <Line type="monotone" dataKey={setup.data1} stackId="a" stroke={setup.color1} strokeWidth={3} >
...
export default CreateTinyLineChart;