...
const CreateStackedAreaChart = () => {
    ...
    return (
        <div>
            <Container>
                <br />
                <h2 className="text-muted border-bottom text-center pb-2">Make Your Customized Stacked Area Chart</h2>
                <br />
                            ...
                            <div id="element" ref={element} >
                                <ResponsiveContainer width={'100%'} height={350} >
                                    ...
                                    >
                                        ...
                                        <Area type="monotone" dataKey={setup.data2} stackId="a" fill={setup.color2} stroke={setup.color2}>
                                            <LabelList dataKey={setup.data2} position="inside" style={{ zIndex: '1' }} />
                                        </Area>

                                        <Area type="monotone" dataKey={setup.data3} stackId="a" fill={setup.color3} stroke={setup.color3}>
