...
const CreateMixBarChart = () => {
    ...
    return (
        <div>
            <Container>
                <br />
                <h2 className="text-muted border-bottom text-center pb-2">Make Your Customized Mix Bar Chart</h2>
                <br />
                            ...
                            <div id="element" ref={element} >
                                <ResponsiveContainer width={'100%'} height={350} >
                                    ...
                                    >
                                        ...
                                        <Tooltip />
                                        <Legend />
                                        <Bar dataKey={setup.data1} stackId="a" fill={setup.color1}>
                                            <LabelList dataKey={setup.data1} position="inside" style={{ zIndex: '1' }} />
                                        </Bar>
                                        <Bar dataKey={setup.data2} stackId="a" fill={setup.color2}>
                                            <LabelList dataKey={setup.data2} position="inside" style={{ zIndex: '1' }} />
                                        </Bar>
                                        <Bar dataKey={setup.data3} fill={setup.color3} stackId="a">
...
export default CreateMixBarChart;